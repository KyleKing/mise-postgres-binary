...
local function download_and_verify_postgresql(version, platform, install_path)
    ...
    if os_type == "windows" then
        ...
        checksum_cmd = string.format('certutil -hashfile "%s" SHA256 | findstr /r "^[0-9a-fA-F][0-9a-fA-F]*$"', temp_archive)
    else
    ...
    local expected_sha256_normalized = expected_sha256:lower()
